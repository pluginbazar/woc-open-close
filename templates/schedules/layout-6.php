...
<div class="wooopenclose-schedules-wrap wooopenclose-schedules-style-<?php echo esc_attr( $style ); ?> <?php echo ( woc_is_open() ) ? 'wooopenclose-shop-schedules-open' : 'wooopenclose-shop-schedules-close'; ?>">
    ...
    <div class="wooopenclose-schedules">
		...
		<?php foreach ( wooopenclose()->get_all_schedules( $set_id ) as $day_id => $day_schedules ) :
            ...
            <div class="wooopenclose-schedule <?php echo esc_attr( !empty( $day_schedules ) ? 'wooopenclose-schedule-open' : 'wooopenclose-schedule-close' ); ?> <?php echo wooopenclose()->get_current_day_id() == $day_id ? 'current opened' : ''; ?> <?php echo woc_is_open() ? 'shop-open' : 'shop-close'; ?> ">

                <span class="schedule-status"><?php echo esc_attr( !empty( $day_schedules ) ? esc_html__( 'Open', 'woc-open-close' ) : esc_html__( 'Close', 'woc-open-close' ) ); ?></span>
